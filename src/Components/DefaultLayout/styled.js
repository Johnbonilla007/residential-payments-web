...
export const AppSidebarStyled = styled.div`
  ...
  /* Submenu container styling (Premium Glassmorphism) */
  .side .submenu {
    text-align: left;
    margin-top: 0.25rem;
    ...
    .ps-submenu-content {
      ...
      .ps-menu-button {
        ...
        &:hover .ps-menu-icon, &.active .ps-menu-icon {
          color: #8083ff;
          transform: scale(1.1);
          filter: drop-shadow(0 0 8px rgba(128, 131, 255, 0.5));
        }
